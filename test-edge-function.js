...
if (!SUPABASE_URL) {
  ...
  console.log('Make sure your dashboard/.env.local file exists and has the correct variables')
  process.exit(1)
}
...
async function testEdgeFunction() {
  const functionUrl = `${SUPABASE_URL}/functions/v1/loan-manager`
  ...
  try {
    ...
    console.log('📊 Found loans:', loansResult.data.map(loan => ({
      name: loan.name,
    ...
    console.log('🌐 Your Edge Function is working and accessible from anywhere!')
